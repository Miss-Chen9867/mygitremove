...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"TeachCourseServlet?method=getTeachCourseStudentList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'tno',title:'教工号',width:130},
 		       	{field:'teacherName',title:'教师姓名',width:110},
 		       	{field:'courseid',title:'课程号',width:60},
 		       	{field:'courseName',title:'课程名',width:200},
 		        {field:'previous',title:'先行课',width:60},
