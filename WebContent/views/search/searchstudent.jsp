...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"StudentServlet?method=FindStudent&t="+new Date().getTime(),
	        idField:'id', 
...
<body>
	...
	<div id="toolbar">
		...
		<div >&nbsp;&nbsp;学号： <input id="sno" class="easyui-textbox" name="sno" /></div>
		<br/>&nbsp;&nbsp;姓名： <input id="name" class="easyui-textbox" name="name" />
